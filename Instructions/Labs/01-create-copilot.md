...
1. In a web browser, navigate to **Copilot Studio** at ~~`https://copilotstudio.microsoft.com`~~ **the url I gave you** and sign in if prompted. Skip any welcome messages.
